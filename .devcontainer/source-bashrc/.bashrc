...
__bash_prompt() {
    ...
    PS1="${userpart} ${lightblue}\w \[\033[0m\]➜\n ${gitbranch}${removecolor}\$ "
...
if [ -f ~/.bash_completion_custom/.docker-completion.sh ]; then
   source ~/.bash_completion_custom/.docker-completion.sh
fi
